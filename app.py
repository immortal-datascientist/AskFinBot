...
from pdf_manager.pdf_storage import list_saved_pdfs, load_vectors, load_image_map, load_table_map
...
if selected_pdf:
    st.session_state.vectors = load_vectors(selected_pdf)
...
# Page router to switch between different pages based on user selection
if option == "Home":
    render_home()
